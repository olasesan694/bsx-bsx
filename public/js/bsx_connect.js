/**
* Copyright (c) 2017-present, Brisebox, Inc. All rights reserved.
*
* You are hereby granted a non-exclusive, worldwide, royalty-free license to use,
* copy, modify, and distribute this software in source code or binary form for use
* in connection with the web services and APIs provided by Brisebox.
*
* As with any software that integrates with the Brisebox platform, your use of
* this software is subject to the Brisebox Platform Policy
* [http://developers.brisebox.com/policy/]. This copyright notice shall be
