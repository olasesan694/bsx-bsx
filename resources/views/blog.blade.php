...
@section('content')
        ...
        <section class="header-section">
            <div class="center-div  text-center">
                <h1 class="font-weight-bold">
                    Today on Shopping Deals & Purchases
                </h1>
                <p>Shopping deals, reviews and new home & living resources.</p>
            </div>
        </section>
    </div>
      ...
      <div class="col-md-8">
        ...
        <div class="card mb-4">
          ...
          <div class="card-footer text-muted">
            ...
            <a href="https://retailers.brisebox.com">Brisebox</a>
          </div>
        </div>
  ...
  <footer class="py-5 bg-dark">
    <div class="container">
      <p class="m-0 text-center text-white">Copyright &copy; Brisebox {{ date('Y') }}</p>
    </div>
    <!-- /.container -->
  </footer>
